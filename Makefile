...
LDFLAGS := -X github.com/takaaki-s/honjin/internal/version.Version=$(VERSION) \
           -X github.com/takaaki-s/honjin/internal/version.Commit=$(COMMIT) \
           -X github.com/takaaki-s/honjin/internal/version.Date=$(DATE)
